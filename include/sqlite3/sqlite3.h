...
#define SQLITE_SOURCE_ID "2024-11-07 12:03:53 6201b5707f8c895028f9c08cb4f83d33a16a91bf04ed3830ac51aa763d6b7205"
...
#define SQLITE_TRANSIENT ((sqlite3_destructor_type) - 1)
    ...
    */
    ...
    SQLITE_API int sqlite3_create_collation_v2(
        sqlite3 *, const char *zName, int eTextRep, void *pArg, int (*xCompare)(void *, int, const void *, int, const void *), void (*xDestroy)(void *));
...
#define SQLITE_CHANGESETSTART_INVERT 0x0002
    ...
    */
    SQLITE_API int sqlite3changeset_upgrade(sqlite3    *db,
                                            const char *zDb,
                                            int         nIn,
                                            const void *pIn, /* Input changeset */
                                            int        *pnOut,
...
#define SQLITE_CHANGESET_ABORT 2
    ...
    */
    ...
    SQLITE_API int sqlite3rebaser_rebase_strm(
        sqlite3_rebaser *pRebaser, int (*xInput)(void *pIn, void *pData, int *pnData), void *pIn, int (*xOutput)(void *pOut, const void *pData, int nData), void *pOut);
